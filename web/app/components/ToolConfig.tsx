...
import { ArrowLeft, Lock, Zap, Unlock, Droplets, RotateCw, Trash2, ArrowUpDown } from 'lucide-react';
            ...
            <div className="flex flex-col gap-6">
                ...
                {toolName === 'Watermark' && (
                    <div className="flex flex-col gap-2 max-w-md">
                        ...
                        <div className="relative">
                            ...
                            <input
                                type="text"
                                className="w-full pl-10 pr-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-cyan-500 outline-none"
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        {selectedPages.length > 0 && (
                            <p className="text-sm text-red-500 mt-1">
                                {selectedPages.length} page{selectedPages.length > 1 ? 's' : ''} will be permanently deleted.
                            </p>
                        )}
                    </div>
                )}
                ...
                {toolName === 'Reorder Pages' && (
                    <div className="flex flex-col gap-2 max-w-md">
                        ...
                        <input
                            type="text"
                            className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-violet-500 outline-none"
                            placeholder="e.g. 3,1,2 or 1,3,2,4"
                            value={pageOrder}
